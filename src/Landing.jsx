...
function LandingPage() {
  ...
  const [chartView, setChartView] = useState('regional') // 'regional' | 'comparison'

  // Pollutant intensity data for chart
  const pollutantData = [
    {
      pollutant: 'PM₂.₅ / PM₁₀',
      India: 240,
    ...
    {
      pollutant: 'Dioxins/Furans',
      India: 2.15,
      Global: 0.1,
    },
    {
      pollutant: 'Heavy Metals (Pb eq.)',
      India: 800,
      Global: 200,
    },
    {
      ...
      <div className="relative flex flex-col gap-20 px-6 pt-24 mx-auto max-w-7xl pb-28 sm:px-10 lg:px-12">
        ...
        >
          <div className="flex flex-col max-w-6xl gap-6 mx-auto">
            {/* Output (2) Image - Above sections */}
            <motion.div
              className="p-4 border shadow-lg rounded-3xl border-emerald-100 bg-white/90"
              initial={{ opacity: 0, y: 24 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, amount: 0.3 }}
              transition={{ delay: 0.1, duration: 0.8, ease: 'easeOut' }}
            >
              <div className="relative w-full overflow-hidden rounded-lg cursor-pointer h-80 group">
                <motion.img
                  src={outputImage2}
                  alt="Regional Analysis Output"
                  className="object-cover w-full h-full transition-transform duration-300 rounded-lg group-hover:scale-110"
                ...
                />
                <div className="absolute inset-0 flex items-center justify-center transition-colors duration-300 rounded-lg pointer-events-none bg-black/0 group-hover:bg-black/20">
                  <motion.span
                    className="text-white opacity-0 group-hover:opacity-100 text-sm font-semibold bg-emerald-600/90 backdrop-blur-sm px-5 py-2.5 rounded-full shadow-lg border border-emerald-400/50"
                    transition={{ duration: 0.3 }}
                  >
                    🔍 Click to enlarge
                  </motion.span>
            ...
            <div className="grid gap-6 lg:grid-cols-[350px,1fr]">
              {/* LIVE DATA FEED - Left side */}
              <motion.div
                className="p-6 border shadow-lg rounded-2xl border-emerald-200/60 bg-gradient-to-br from-emerald-50/90 via-white to-emerald-50/60 backdrop-blur"
                initial={{ opacity: 0, y: 24 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true, amount: 0.3 }}
              ...
              >
                ...
                <div className="flex items-center gap-2 mb-6">
                  ...
                  <span className="text-sm font-bold tracking-wide uppercase text-emerald-700">
                    LIVE DATA FEED
                  </span>
                </div>

                {/* Live Data Feed Content */}
                <motion.div
                  key="data"
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                ...
                >
                  <motion.span
                    className="inline-block px-3 py-1 mb-2 text-xs font-semibold border rounded-full bg-emerald-100 text-emerald-700 border-emerald-200"
                    animate={{
                      boxShadow: [
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 text-xl bg-orange-100 rounded-lg">
                          💨
                        </div>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 text-xl bg-red-100 rounded-lg">
                          ☠️
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="mb-1 text-sm font-semibold text-slate-800">
                          ...
                          <p className="text-xs text-slate-600">
                            Detected: <span className="font-bold text-red-600">0.08 pg/m³</span> (Toxic compound)
                          </p>
                        </div>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 text-xl bg-purple-100 rounded-lg">
                          🧫
                        </div>
                        <div className="flex-1 min-w-0">
                          <p className="mb-1 text-sm font-semibold text-slate-800">
                          ...
                          <p className="text-xs text-slate-600">
                            Airborne: <span className="font-bold text-purple-600">1,300 particles/m²/day</span>
                          </p>
                        </div>
                      </div>
                    </motion.div>
                  ...
                  {/* Button to open Bhalswa Dashboard */}
                  <motion.button
                    onClick={() => navigate("/bhalswa")}
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.6, duration: 0.6, ease: "easeOut" }}
                    className="w-full px-4 py-3 mt-4 text-sm font-semibold text-white transition-all shadow-md rounded-xl bg-emerald-600 hover:bg-emerald-700 hover:shadow-lg focus:outline-none"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                  >
              ...
              {/* Regional Exposure / Comparison - Right side with toggle */}
              <motion.div
                className="p-4 border shadow-lg rounded-3xl border-emerald-100 bg-white/90"
                initial={{ opacity: 0, y: 24 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="flex items-center justify-between gap-3 mb-3">
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs text-slate-600">
                      Emission Intensity in Delhi NCR & global comparison
                    </p>
                  </div>

                  {/* Toggle between charts */}
                  <div className="flex items-center p-1 text-[11px] rounded-full bg-emerald-50 border border-emerald-100">
                    <button
                ...
                <motion.span
                  className="relative px-2 py-1 mb-3 overflow-hidden text-xs font-medium border rounded-full border-emerald-100 bg-emerald-50 text-emerald-700 shrink-0 w-fit"
                  animate={{
                    boxShadow: [
                      '0 0 0 0 rgba(16, 185, 129, 0.4)',
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center gap-1">
                    ...
                    <span className="text-xs">
                      {chartView === 'regional' ? 'Realtime exposure' : 'Delhi NCR vs global benchmark'}
                    </span>
                  </span>
                </motion.span>
                ...
                <div className="w-full h-96">
                  {chartView === 'regional' ? (
                    <motion.img
                      src={outputImage}
                      alt="Regional Exposure Signal - Microplastic vs CO2 burden by system layer"
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                      ...
                      >
                        ...
                        <Tooltip />
                        <Legend />
                        <Bar dataKey="India" fill="#10b981" name="Delhi NCR (India)" />
                        <Bar dataKey="Global" fill="#2563eb" name="Global benchmark" />
                      </BarChart>
                    </ResponsiveContainer>
                  )}
                </div>
        ...
        {isImageZoomed && (
          ...
          >
            ...
            >
              <motion.img
                src={outputImage2}
                alt="Regional Analysis Output - Enlarged"
                className="max-w-full max-h-[95vh] object-contain rounded-lg shadow-2xl"
              />
              <motion.button
                onClick={() => setIsImageZoomed(false)}
                className="absolute z-10 flex items-center justify-center w-12 h-12 transition-colors rounded-full shadow-xl top-4 right-4 bg-white/95 hover:bg-white text-slate-700 hover:text-slate-900"
              ...
              <motion.div
                className="absolute px-4 py-2 text-sm text-white -translate-x-1/2 rounded-full bottom-4 left-1/2 bg-black/70 backdrop-blur-sm"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
